    ...
    <div class="view-content">
        ...
        {if $action eq 16 and $permission EQ 'edit'}
            <div class="action-link">
                ...
                {/if}
                <a id="sepa_payment_extra_button" class="button" href="{crmURL p="civicrm/sepa/cmandate" q="cid=$contactId"}"><span><div class="icon add-icon ui-icon-circle-plus"></div>{ts domain="org.project60.sepa"}Record SEPA Contribution{/ts}</span></a>
                <br /><br />
            </div>
      <div class='clear'> </div>
        {/if}
